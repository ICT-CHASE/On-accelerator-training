...
const char *mean_data_file_path    = "/home/xkz/workspace/pipecnn-5-17/src/PipeCNN/data/imagenet/mean_data.dat";
const char *synset_word_file_path  = "/home/xkz/workspace/pipecnn-5-17/src/PipeCNN/data/imagenet/synset_words.txt";
const char *LabelPath		   = "/home/xkz/workspace/pipecnn-5-17/src/PipeCNN/data/imagenet/val.txt";
...
#define LAYER_NUM         8
#define CONV_NUM          5
const char *weight_file_path = "/home/xkz/workspace/pipecnn-5-17/src/PipeCNN/data/data_alex/weights.dat";
const char *input_file_path = "/home/xkz/workspace/pipecnn-5-17/src/PipeCNN/data/data_alex/image.dat";
const char *ref_file_path = "/home/xkz/workspace/pipecnn-5-17/src/PipeCNN/data/data_alex/fc8.dat";
...
layer_config[0][weight_n]=3;
	...
	char *kernel_file_name="binary_container_1.xclbin";//param[1];
...
std::cout<<"pipecnn 349 1ddr"<<std::endl;
			...
			checkError(status, "Failed to create buffer for weights in layer");
std::cout<<"pipecnn 365 4ddr"<<std::endl;
			// Bias buffers for each layer
			...
			checkError(status, "Failed to create buffer for weights in layer");
std::cout<<"pipecnn 365 intel"<<std::endl;
			// Bias buffers for each layer
...
//	}
	...
	static int caffev=0;
        int outputCountCaffe=layer_config[layer][pool_x]*layer_config[layer][pool_y]*layer_config[layer][pool_z];
...
int load_picture(DTYPE *imageCaffe){
...
//xkz:release golbal memoty until train or test end
		if(data_buf && data_buf[i]) {
			statusxkz=clReleaseMemObject(data_buf[i]);
			data_buf[i]=NULL;
		}
