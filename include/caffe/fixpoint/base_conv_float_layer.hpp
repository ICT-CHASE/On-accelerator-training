#ifndef CAFFE_BASE_CONVOLUTION_LAYER_FLOAT_HPP_
#define CAFFE_BASE_CONVOLUTION_LAYER_FLOAT_HPP_
...
/**
 * @brief 浮点计算的Base Conv layer, for test and debugging
 */
template <typename Dtype>
class BaseConvolutionFloatLayer : public Layer<Dtype> {
 public:
  explicit BaseConvolutionFloatLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
...
#endif  // CAFFE_BASE_CONVOLUTION_FLOAT_LAYER_HPP_
