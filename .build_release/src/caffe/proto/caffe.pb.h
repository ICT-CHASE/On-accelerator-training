...
class QCodeConfig : public ::google::protobuf::Message {
 public:
  QCodeConfig();
  virtual ~QCodeConfig();

  QCodeConfig(const QCodeConfig& from);

  inline QCodeConfig& operator=(const QCodeConfig& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const QCodeConfig& default_instance();

  void Swap(QCodeConfig* other);

  // implements Message ----------------------------------------------

  QCodeConfig* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const QCodeConfig& from);
  void MergeFrom(const QCodeConfig& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional uint32 il = 1 [default = 4];
  inline bool has_il() const;
  inline void clear_il();
  static const int kIlFieldNumber = 1;
  inline ::google::protobuf::uint32 il() const;
  inline void set_il(::google::protobuf::uint32 value);

  // optional uint32 fl = 2 [default = 4];
  inline bool has_fl() const;
  inline void clear_fl();
  static const int kFlFieldNumber = 2;
  inline ::google::protobuf::uint32 fl() const;
  inline void set_fl(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.QCodeConfig)
 private:
  inline void set_has_il();
  inline void clear_has_il();
  inline void set_has_fl();
  inline void clear_has_fl();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::uint32 il_;
  ::google::protobuf::uint32 fl_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static QCodeConfig* default_instance_;
};
// -------------------------------------------------------------------
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  inline const ::caffe::RecurrentParameter& recurrent_param() const;
  inline ::caffe::RecurrentParameter* mutable_recurrent_param();
  inline ::caffe::RecurrentParameter* release_recurrent_param();
  inline void set_allocated_recurrent_param(::caffe::RecurrentParameter* recurrent_param);
  ...
  // repeated .caffe.QCodeConfig qcodeconfig = 200;
  inline int qcodeconfig_size() const;
  inline void clear_qcodeconfig();
  static const int kQcodeconfigFieldNumber = 200;
  inline const ::caffe::QCodeConfig& qcodeconfig(int index) const;
  inline ::caffe::QCodeConfig* mutable_qcodeconfig(int index);
  inline ::caffe::QCodeConfig* add_qcodeconfig();
  inline const ::google::protobuf::RepeatedPtrField< ::caffe::QCodeConfig >&
      qcodeconfig() const;
  inline ::google::protobuf::RepeatedPtrField< ::caffe::QCodeConfig >*
      mutable_qcodeconfig();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::caffe::QCodeConfig > qcodeconfig_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
// optional uint32 il = 1 [default = 4];
inline bool QCodeConfig::has_il() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void QCodeConfig::set_has_il() {
  _has_bits_[0] |= 0x00000001u;
}
inline void QCodeConfig::clear_has_il() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void QCodeConfig::clear_il() {
  il_ = 4u;
  clear_has_il();
}
inline ::google::protobuf::uint32 QCodeConfig::il() const {
  // @@protoc_insertion_point(field_get:caffe.QCodeConfig.il)
  return il_;
}
inline void QCodeConfig::set_il(::google::protobuf::uint32 value) {
  set_has_il();
  il_ = value;
  // @@protoc_insertion_point(field_set:caffe.QCodeConfig.il)
}

// optional uint32 fl = 2 [default = 4];
inline bool QCodeConfig::has_fl() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void QCodeConfig::set_has_fl() {
  _has_bits_[0] |= 0x00000002u;
}
inline void QCodeConfig::clear_has_fl() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void QCodeConfig::clear_fl() {
  fl_ = 4u;
  clear_has_fl();
}
inline ::google::protobuf::uint32 QCodeConfig::fl() const {
  // @@protoc_insertion_point(field_get:caffe.QCodeConfig.fl)
  return fl_;
}
inline void QCodeConfig::set_fl(::google::protobuf::uint32 value) {
  set_has_fl();
  fl_ = value;
  // @@protoc_insertion_point(field_set:caffe.QCodeConfig.fl)
}
...
inline ::caffe::RecurrentParameter* LayerParameter::mutable_recurrent_param() {
  ...
  if (recurrent_param_ == NULL) recurrent_param_ = new ::caffe::RecurrentParameter;
...
// repeated .caffe.QCodeConfig qcodeconfig = 200;
inline int LayerParameter::qcodeconfig_size() const {
  return qcodeconfig_.size();
}
inline void LayerParameter::clear_qcodeconfig() {
  qcodeconfig_.Clear();
}
inline const ::caffe::QCodeConfig& LayerParameter::qcodeconfig(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.qcodeconfig)
  return qcodeconfig_.Get(index);
}
inline ::caffe::QCodeConfig* LayerParameter::mutable_qcodeconfig(int index) {
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.qcodeconfig)
  return qcodeconfig_.Mutable(index);
}
inline ::caffe::QCodeConfig* LayerParameter::add_qcodeconfig() {
  // @@protoc_insertion_point(field_add:caffe.LayerParameter.qcodeconfig)
  return qcodeconfig_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::caffe::QCodeConfig >&
LayerParameter::qcodeconfig() const {
  // @@protoc_insertion_point(field_list:caffe.LayerParameter.qcodeconfig)
  return qcodeconfig_;
}
inline ::google::protobuf::RepeatedPtrField< ::caffe::QCodeConfig >*
LayerParameter::mutable_qcodeconfig() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LayerParameter.qcodeconfig)
  return &qcodeconfig_;
}
